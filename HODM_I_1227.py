...
def increament_learning_(NP_,pos,count,K,newpos_l,analyse_result_l,prop=1):
    #仅增加坐标
    #count  neighbor data 
    ...
    while times < repeat_time:
        ...
        for typeName in anomalyType:
            ...
            for subtype in anomalyType[typeName]:
                ...
                #插入异常
                data1,outlier_pos1  = insert_anomaly(data1, start, anomaly_num, typeName, 
                ...
                out_noisefilestr_ = 'datasets/withnoise/'+str(times)+'_'+ typeName +'_'+ str(subtype)+'.csv'
                ...
                for i in range(member_size):
                    ...
                    Output_DF.to_csv(exp_str+'.csv',header=0,mode='a')
            #one test
