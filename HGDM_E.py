...
def update(df1,df2,df3,begin,end,H_range,sample_for_k):
    global_info_l = []
    NP_df_l = [] 
    K_l = []
...
#intel 1
        ...
        datefile1 = 'datasets/node43.csv'
        datefile2 = 'datasets/node44.csv'
        datefile3 = 'datasets/node45.csv'
...
#         bufferSize = 300
       ...
       #pretrain 300
        begin = 0 
        Global_info_list , NP_df_list , K_list = update(data1,data2,data3,begin,bufferSize,H_range,sampleforK)
        ...
        for row in range(bufferSize,datalen):
            ...
            if count%bufferSize ==0:
                count = 0 
                Global_info_list , NP_df_list , K_list = update(data1,data2,data3,row - bufferSize,row,H_range,sampleforK)
